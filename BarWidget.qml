  ...
  BarIconButton {
    ...
    iconComponent: Component {
      AnalogClock {
        ...
        trackColor: root.timerService && root.timerService.awaitingAck ? Color.urgent : Color.foreground
        fillColor: root.timerService && root.timerService.awaitingAck ? Color.urgent : Color.foreground
